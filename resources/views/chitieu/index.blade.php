...
<div class="showMain" style="padding: 5px;">
    ...
    <form action="{{url('/themchitieu')}}" method="post">
        @csrf
        <div class="d-flex">
            <div class="w-75 m-2">
                <label class="form-label">Tên chỉ tiêu</label>
                <input name="tenchitieu" type="text" class="form-control">
            </div>
            <button style="height: 40px; width: 50%; transform: translateY(1.8rem)" type="submit" class="btn btn-primary m-2 w-25">Thêm chỉ tiêu</button>
        </div>
    </form>
