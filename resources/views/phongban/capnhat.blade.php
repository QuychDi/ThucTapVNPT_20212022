...
<section class="home-section">
    <div class="home-content">
        ...
        <span class="text">Cập nhật phòng ban</span>
        @if (session('error'))
...
<div class="showMain" style="padding: 5px;">
    ...
    <form action="{{url('/capnhatphongban/'.$value2->ID_PHONGBAN)}}" method="post">
        @csrf
        <div class="d-flex">
            <div class="w-50 m-2">
                <label class="form-label">Tên phòng ban</label>
                <input name="tenphongban" type="text" class="form-control" value="{{$value2->Ten_PhongBan}}">
            </div>
            <div class="w-25 m-2">
            ...
            <button style="height: 40px; width: 50%; transform: translateY(1.8rem)" type="submit" class="btn btn-primary m-2 w-25">Lưu</button>
        </div>
    </form>
    @endforeach
